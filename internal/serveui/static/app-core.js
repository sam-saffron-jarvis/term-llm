...
const elements = {
  ...
  sideQuestionQuestion: document.getElementById('sideQuestionQuestion'),
  sideQuestionResponse: document.getElementById('sideQuestionResponse'),
  sideQuestionError: document.getElementById('sideQuestionError'),
  sideQuestionPosition: document.getElementById('sideQuestionPosition'),
  sideQuestionCloseBtn: document.getElementById('sideQuestionCloseBtn'),
  sideQuestionPrevBtn: document.getElementById('sideQuestionPrevBtn'),
  sideQuestionNextBtn: document.getElementById('sideQuestionNextBtn'),
